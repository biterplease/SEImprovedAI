...
namespace BetterAIConstructor.Navigation
{
    public class NavigationManager
    {
        ...
        public NavigationManager(BAIController controller, PathfindingManager pathfindingManager, BAIConstructorDroneConfig config)
        {
